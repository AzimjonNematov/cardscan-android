...
private val ISSUER_TABLE: List<IssuerData> = listOf(
    ...
    IssuerData(860000..869999, CardIssuer.Uzcard, (16..19).toList(), listOf(3), LengthPanValidator + LuhnPanValidator),
    IssuerData(986000..986999, CardIssuer.Humo, (16..19).toList(), listOf(3), LengthPanValidator + LuhnPanValidator),
    IssuerData(998700..998799, CardIssuer.Atto, (16..19).toList(), listOf(3), LengthPanValidator + LuhnPanValidator),
)
